...
public class DrPresenter {
    ...
    public DrPresenter(Context context,Activity activity){
    ...
    public void initViewPager(HorizontalViewPager horizontalViewPager) {
        ...
        iv1.initImageResource(activity,R.drawable.dr_blue,600,900);
        ...
        iv2.initImageResource(activity,R.drawable.dr_pink,600,900);
        ...
        replace1.setImageResource(R.drawable.dr_pink);
        ...
        replace2.setImageResource(R.drawable.dr_blue);

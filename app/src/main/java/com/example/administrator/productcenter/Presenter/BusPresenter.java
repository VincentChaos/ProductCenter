...
public class BusPresenter {
    ...
    public BusPresenter(Context context,Activity activity){
    ...
    public void initViewPager(HorizontalViewPager horizontalViewPager){
        ...
        iv1.initImageResource(activity,R.drawable.bus_1,400,900);
        ...
        iv2.initImageResource(activity,R.drawable.bus_2,400,900);
        ...
        iv3.initImageResource(activity,R.drawable.bus_3,400,900);
        ...
        iv4.initImageResource(activity,R.drawable.bus_4,400,900);

        View view5 = LayoutInflater.from(context).inflate(R.layout.layout_robot,null);
        RobotImageView iv5 = view5.findViewById(R.id.image_robot);
        iv5.initImageResource(activity,R.drawable.bus_5,400,900);

        View view6 = LayoutInflater.from(context).inflate(R.layout.layout_robot,null);
        RobotImageView iv6 = view6.findViewById(R.id.image_robot);
        iv6.initImageResource(activity,R.drawable.bus_6,400,900);
        ...
        replace1.setImageResource(R.drawable.bus_6);
        ...
        replace2.setImageResource(R.drawable.bus_1);
